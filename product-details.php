	...
	<div class="body-content outer-top-xs">
		<div class='container'>
			<div class='row single-product outer-bottom-sm '>
				<div class='col-md-6 col-lg-12 sidebar'>
									...
									<div class="price-container info-container m-t-20">
										<div class="row">
											...
											<div class="col-sm-6 col-md-9 col-lg-12">
												<div class="price-box">
													<span class="price">
														<div class="white"><?php echo htmlentities($row['calories']*1.0); ?> kCal</div>
														<hr>
														<span class="white pc" style="font-size:large;">
															...
															<span><a href="#" class="btn btn-primary " style="color: white !important;"> VISIT</a></span>

														</span>
														<hr>
														<span class="white pc" style="font-size:large;">
															<?php $currentP = $row['productPrice'] + round($row['productPrice'] * mt_rand() / mt_getrandmax(), 2); ?>
															<span><?php echo "The Hylton Cafe"; ?></span>
															<span>£ <?php echo $currentP; ?></span>
														...
														<span class="white pc" style="font-size:large;">
															...
															<span><?php echo "Carters of Moseley "; ?></span>
															<span> £ <?php echo htmlentities(round($row['productPrice'] * mt_rand() / mt_getrandmax(), 2)); ?></span>
															<span><a href="#" class="btn btn-primary" style="color: white !important;"> VISIT</a></span>
														</span>

														<span class="price-strike pc" style="padding: 5px 5px 5px 5px; color: white !important;">£<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span>
										...
										<div class="row">
											...
											<div class="col-sm-7">
												<?php if ($row['productAvailability'] == 'In Stock') { ?>
													...
													<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary" style="color: white !important;"><i class="fa fa-Shopping-cart inner-right-vs"></i> ADD TO CART</a>
												<?php } else { ?>
							...
							<div class="row">
								<div class="col-sm-3">
									<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
										...
										<li style="background: navy; color: white !important;" ><a data-toggle="tab" href="#review">REVIEW</a></li>
									</ul><!-- /.nav-tabs #product-tabs -->
								</div>
								<div class="col-sm-9 col-md-12 col-lg-12" style="font-size: 24px; font-weight: bold; ">
