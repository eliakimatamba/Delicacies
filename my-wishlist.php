...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
<?php
$ret=mysqli_query($con,"select products.productPriceBeforeDiscount, products.calories,products.productName as pname,products.productName as proid,products.productImage1 as pimage,products.productPrice as pprice,wishlist.productId as pid,wishlist.id as wid from wishlist join products on products.id=wishlist.productId where wishlist.userId='".$_SESSION['id']."'");
...
?>
				...
				<tr>
					<td class="col-md-3"><img src="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="180" height="120"></td>
					<td class="col-md-6">
...
?>
						...
						<?php } ?>
						<div class="price">
						<div style="color: purple !important"> <?php echo htmlentities($row['calories']); ?> kCal</div>	
