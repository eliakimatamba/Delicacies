...
<div class="logo">
	...
	<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Leckerli+One" />
		<h2 style="color: #00308F !important; font-size: 50px; font-family: Leckerli One;">Delicacies</h2>
...
if(!empty($_SESSION['cart'])){
			...
			<div class="items-cart-inner">
				<div class="total-price-basket">
					...
					<span class="total-price">
						<span class="sign">Calories </span>
						<span class="value"><?php echo $_SESSION['tc']; ?></span>
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							£<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
								<div> <?php echo ($row['calories']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?> kCal</div>
						</div>
			...
			<div class="clearfix cart-total">
				...
				<div>Cal. <?php echo $_SESSION['tc']="$totalcalories" ?> kCal</div>
