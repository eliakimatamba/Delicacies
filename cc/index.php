...
bootstrap-slider.min.js"></script>
    ...
    <div class="container">
                ...
                <form class="col">
                    <div class="row">
                        <div class="input-field col s6">
                            <label for="item-name" class="main-input" style="position: relative; padding-bottom: 10px;">Search</label>
                            ...
                            <div class="search-box">
                                <input class="main-input add-cart-button" id="item-calories" type="text" autocomplete="off" placeholder="Dishes " />
                                <div class="result" style="color: white; font-weight:bolder;
                                                            font-size:large; background-color: purple;"></div>
                                <button class="add-btn btn teal" style="background-color: purple !important; position:absolute;" >
        ...
        <h3 class="center-align" style="padding-top: 250px;">
