...
<body class="cnt-home">
                                        ...
                                        <div class="accordion-group">
                                            <div class="accordion-heading">
                                                <a href="category.php?cid=<?php echo $row['id']; ?>" class="accordion-toggle collapsed">
                                                    <div class="white" style="font-size: 18px; font-height: 24px;"><strong><?php echo $row['categoryName']; ?></strong></div>
                                                </a>
                                            </div>
                                    ...
                                    <div class="item">
                                        <div class="products">
                                            <div class="hot-deal-wrapper">
                                                <div class="image">
                                                    <img src="admin/productimages/<?php echo htmlentities($rws['id']); ?>/<?php echo htmlentities($rws['productImage1']); ?>" width="334" height="200" alt="">
                                                </div>

                                            </div><!-- /.hot-deal-wrapper -->

                                            <div class="product-info text-left m-t-20">
                                                <h3 class="name white"><a href="product-details.php?pid=<?php echo htmlentities($rws['id']); ?>"><?php echo htmlentities($rws['productName']); ?></a></h3>
                                                <div class="rating rateit-small"></div>

                                                <div class="product-price">
                                                    <span class="price">
                                                        <div class="white"> <?php echo htmlentities($rws['calories']); ?> kCal</div>
                                                        <div class="white">£ <?php echo htmlentities($rws['productPrice']); ?>.00</div>
                                                    </span>

                                                    <span class="price-before-discount white">£<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span>
                                                        ...
                                                        <button class="btn btn-primary icon" data-toggle="dropdown" type="button">
                                                            <?php if ($row['productAvailability'] == 'In Stock') { ?>
                                                                ...
                                                                <a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
                                                                    <button class="btn btn-primary white" type="button">Add to cart</button></a>
                                                            <?php } else { ?>
                        ...
                        <div class="row  wow fadeInUp">
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    <h1 class="name white"><?php echo htmlentities($row['productName']); ?></h1>
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="stock-box">
                                                    <span class="label white">Availability :</span>
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value white"><?php echo htmlentities($row['productAvailability']); ?></span>
                                                </div>
                                            </div>
                                        </div><!-- /.row -->
                                    </div>
                                    ...
                                    <div class="stock-container info-container m-t-10" style="color: white !important;">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="stock-box">
                                                    <span class="label white">Product Brand :</span>
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value white"><?php echo htmlentities($row['productCompany']); ?></span>
                                                </div>
                                            </div>
                                        </div><!-- /.row -->
                                    </div>
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="stock-box">
                                                    <span class="label white">Shipping Charge : £</span>
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value white"><?php if ($row['shippingCharge'] == 0) {
                                                                                    echo "Free";
                                                                                } else {
                                    ...
                                    <div class="price-container info-container m-t-20">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    <span class="price">
                                                        <div class="white"><?php echo htmlentities($row['calories']); ?> kCal</div>

                                                        <span class="white pc" style="font-size:large;">

                                                            <?php echo htmlentities($row['productCompany']); ?>
                                                            £ <?php echo htmlentities($row['productPrice']); ?>
                                                            <ul class="pc">visit</ul>
                                                        </span>
                                                        <div class="white pc" style="font-size:large;">
                                                            <?php $currentP = $row['productPrice'] + round($row['productPrice'] * mt_rand() / mt_getrandmax(), 2); ?>
                                                            <?php echo "The Hylton Cafe"; ?>
                                                            £ <?php echo $currentP; ?>
                                                        ...
                                                        <div class="white pc" style="font-size:large;">
                                                            ...
                                                            <?php echo "Carters of Moseley "; ?>
                                                            £ <?php echo htmlentities(round($row['productPrice'] * mt_rand() / mt_getrandmax(), 2)); ?>
                                                            <ul class="pc">visit</ul>
                                                        </div>

                                                        <div class="price-strike pc" style="padding: 5px 5px 5px 5px; color: white !important;">£<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></div>
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <span class="label white">Qty :</span>
                                            </div>
                                            ...
                                            <div class="col-sm-7">
                                                <?php if ($row['productAvailability'] == 'In Stock') { ?>
                                                    ...
                                                    <a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary white"><i class="fa fa-Shopping-cart inner-right-vs"></i> ADD TO CART</a>
                                                <?php } else { ?>
                                                    <div class="action" style="color:red">Out of Stock</div>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <div class="product-social-link m-t-20 text-right">
                                        <span class="social-label white">Share :</span>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
                                        <li class="active white"><a data-toggle="tab" href="#description">DESCRIPTION</a></li>
                                        <li class="white"><a data-toggle="tab" href="#review">REVIEW</a></li>
                                        ...
                                        <div id="review" class="tab-pane">
                                            <div class="product-tab">
                                                ...
                                                <div class="product-reviews">
                                                    <h4 class="title white">Customer Reviews</h4>
                                                ...
                                                <form role="form" class="cnt-form" name="review" method="post">
                                                    ...
                                                    <div class="product-add-review">
                                                        <h4 class="title white">Write your own review</h4>
                                                        <div class="review-table">
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="cell-label white">&nbsp;</th>
                                                                            <th>1 star</th>
                                                                            <th>2 stars</th>
                                                                            <th>3 stars</th>
                                                                            <th>4 stars</th>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="cell-label white">Quality</td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="cell-label white">Price</td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="cell-label white">Value</td>
                                                        ...
                                                        <div class="review-form">
                                                            <div class="form-container">
                                                                ...
                                                                <div class="action text-right">
                                                                    <button name="submit" class="btn btn-primary btn-upper white">SUBMIT REVIEW</button>
                                                                </div><!-- /.action -->
    ...
    <section class="section featured-product wow fadeInUp">
        <h3 class="section-title white">Compare Products </h3>
                    ...
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image">
                                    <a href="product-details.php?pid=<?php echo htmlentities($rw['id']); ?>"><img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']); ?>/<?php echo htmlentities($rw['productImage1']); ?>" width="240" height="150" padding="3px" alt=""></a>
                                </div><!-- /.image -->
                            ...
                            <div class="product-info text-left">
                                ...
                                <div class="product-price">
                                    <span class="price">
                                        <div style="color: white !important"> <?php echo htmlentities($rw['calories']); ?> kCal </div>
                                        <div class="white">£<?php echo htmlentities($rw['productPrice']); ?></div>
                                    </span>
                                    <span class="price-before-discount">

                                        <div style="color: white !important">£ <?php echo htmlentities($rw['productPriceBeforeDiscount']); ?></div>
                                    </span>
                                    <div style="color: orangered !important; font-weight: bolder; font-size: 18px;"> <?php echo htmlentities($rw['productCompany']); ?>
                                    </div><!-- /.product-price -->

                                </div><!-- /.product-info -->
                                <div class="cart clearfix animate-effect white">
                                    <div class="action">
                                        <ul class="list-unstyled">
                                            <li class="add-cart-button btn-group ">
                                                ...
                                                <a style="background: black !important; color: white !important;" href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary white">Add to cart</a>
