									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="cart-sub-total item">Calories/Unit</th>
											...
											<tr>
												<td colspan="7">
													<div class="Shopping-cart-btn">
														<span class="">
															<a href="index.php" class="btn btn-upper btn-primary outer-left-xs brdc">Continue Shopping</a>
															<input type="submit" name="submit" value="Update Shopping cart" class="btn btn-upper btn-primary pull-right outer-right-xs brdc">
														</span>
										...
										<tbody>
											...
											if (!empty($query)) {
												while ($row = mysqli_fetch_array($query)) {
													...
													$totalprice += $subtotal;
													$calorieSub = $_SESSION['cart'][$row['id']]['quantity'] * $row['calories'];
													...
													<tr>
														...
														<td class="cart-image">
															<a class="entry-thumbnail" href="detail.html">
																<img src="admin/productimages/<?php echo $row['id']; ?>/<?php echo $row['productImage1']; ?>" alt="" width="146" height="114">
															</a>
														</td>
														...
														<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo  $row['calories']." "."kCal"; ?></span></td>
